...
void start_game(){
    ...
    }
    {
        ...
        NewButton* mode1 = new NewButton(100, 180, 100, 100, 5);
        NewButton* mode2 = new NewButton(240, 170, 120, 120, 6);
        NewButton* bac = new NewButton(160,300, 150, 36, 4);
    ...
    {
        Fl_Group* Gr = new Fl_Group(0,0,500,405," ");
        DotBox* Back = new DotBox(0,0,500,405,2);
        NewButton* dft = new NewButton(160, 180, 180, 43, 2);//创建deafult按钮
        NewButton* ctm = new NewButton(160, 230, 180, 43, 3);//创建customize按钮
        NewButton* bac = new NewButton(160, 280, 180, 43, 4);//创建back按钮
    ...
    }
    {
        ...
        NewButton* bac = new NewButton(330,50, 150, 36, 4);//创建back按钮
