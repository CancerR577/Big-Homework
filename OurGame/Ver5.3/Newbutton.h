...
public:
    NewButton(int X, int Y, int W, int H, int choice) : Fl_Button(X,Y,W,H)
    {
        ...
        case 5:
           m_pSharedImage = Fl_Shared_Image::get("Choice1.PNG"); break;
        case 6:
           m_pSharedImage = Fl_Shared_Image::get("Choice2.PNG"); break;
        case 7:
           m_pSharedImage = Fl_Shared_Image::get("Restart.PNG"); break;
        }
