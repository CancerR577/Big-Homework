...
ScoreBoard::ScoreBoard ( int s1, int s2 , int p ,StartAndEnd* &sae)
    ...
    , sbsae { sae }
{
    namelabel_1 = new Circle_Box(R_BOX,730 ,150 , 120 , 120);
    namelabel_2 = new Circle_Box(R_BOX,730 ,300 , 120 , 120);
    fl_register_images();
    ...
    scorebox1 = new Fl_Value_Output { 900 , 200 , 50 , 50 };
    scorebox2 = new Fl_Value_Output { 900 , 350 , 50, 50 };
