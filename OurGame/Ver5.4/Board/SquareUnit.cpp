...
SquareUnit::SquareUnit(int x, int y, int w, int h, int d, Squares* sqss)
        : Fl_Box(x,y,w,h)
        , deg{d}
        , PlayerNumber{1}
        , sqs{sqss}
...
void SquareUnit::activation()
{
    ...
    case 0:
        ...
        case 1:
            fl_register_images();
            square_pic = Fl_Shared_Image::get("Img/rook.PNG");
        ...
        case 2:
            fl_register_images();
            square_pic = Fl_Shared_Image::get("Img/queen.PNG");
