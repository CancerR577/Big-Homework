...
void StartAndEnd::game_start(int r,int c,int t)
{
    ...
    bw = new Back_Window(1200,750);

    SimpleBoard(rownum, colnum, this, type);

    NewButton* Quit = new  NewButton(1000, 60, 150, 36, 1);
    NewButton* Restart = new  NewButton(1000, 20, 150, 36, 7);
...
void StartAndEnd::game_over(int who)
{
    ...
    switch (who){
    case 1 :
        rep = fl_choice("Winner:The Dark Rook!\nPlay again?","Replay","Reset", "Exit");
        break;
    case 2 :
        rep = fl_choice("Winner:The Red Queen!\nPlay again?","Replay","Reset", "Exit");
        break;
    case 3 :
