...
ScoreBoard::ScoreBoard ( int s1, int s2 , int p ,StartAndEnd* &sae)
    ...
    , sbsae { sae }
{
    namelabel_1 = new Circle_Box(R_BOX,710 ,50 , 120 , 120);
    namelabel_2 = new Circle_Box(R_BOX,710 ,200 , 120 , 120);
    fl_register_images();
    ...
    scorebox1 = new Fl_Value_Output { 880 , 100 , 50 , 50 };
    scorebox2 = new Fl_Value_Output { 880 , 250 , 50, 50 };
